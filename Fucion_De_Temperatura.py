...
# Ejemplo de uso
# Se llama a la función con los datos de temperatura proporcionados.
# Los resultados se almacenan en el diccionario resultados.
# Se imprime la temperatura promedio para cada ciudad con dos decimales.
...
#Este programa es útil para analizar las tendencias de temperatura en diferentes ubicaciones durante un período de tiempo específico. 🌡️🌎
